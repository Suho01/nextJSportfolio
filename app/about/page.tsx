                ...
                <div className="max-w-7xl mx-auto">
                    <div className="h-auto flex overflow-hidden mt-8 flex-wrap justify-between">
                        <div className="basis-full md:basis-[30%] py-12 px-4 bg-white rounded-md dark:bg-[#272929] dark:text-[#ebf4f1] text-center border">
                            ...
                            <ul>
                                <li className="pl-5 box-border pt-6">김준면 / Kim Jun Myeon</li>
                                <li className="pl-5 box-border pt-6">1991.05.22</li>
                                <li className="pl-5 box-border pt-6"><a href="mailto:suhoprimavera@gmail.com">suhoprimavera@gmail.com</a></li>
                                {/* Link : 내 사이트 내에서 컴포넌트끼리 넘어가는 것 a : 다른 사이트로 넘어가는 것 */}
                            </ul>
                        </div>
